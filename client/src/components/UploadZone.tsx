        ...
        {file ? (
          <>
            <img
              ...
              alt="preview"
              className="absolute inset-0 wp-full h-full object-cover rounded-xl opacity-60"
            />
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-md p-3 rounded-lg border-e-red-50 border-white/10">
