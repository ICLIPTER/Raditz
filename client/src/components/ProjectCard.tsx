      ...
      <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
        ...
        >
          {gen.generatedImage && (
            <img
              ...
              alt={gen.productName}
              className={`absolute inset-0 h-full w-full object-cover transition duration-500 ${gen.generatedVideo ? "group-hover:opacity-0" : "group-hover:scale-105"}`}
            />
          )}
          ...
          {!gen?.generatedImage && !gen?.generatedVideo && (
            <div className="absolute inset-0 h-full w-full flex flex-col items-center justify-center bg-black/20">
        ...
        <div className="p-4">
          <div className="flex items-start justify-between gap-4">
            {/* project name, date, aspect ratio */}
