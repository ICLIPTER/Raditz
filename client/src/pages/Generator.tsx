          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              ...
              <input
                ...
                required
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:via-violet-500/50 outline-none transition-all"
              />
            </div>
            <div className="mb-4 text-gray-300">
            ...
            <div className="mb-4 text-gray-300">
              <label className="block text-xs mb-4">Aspect Ratio</label>
              <div className="flex gap-3">
                <RectangleVerticalIcon
                  onClick={() => setAspectRatio("9:16")}
                  className={`p-2 size-13 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer${aspectRatio === "9:16" ? " ring-violet-500/50 bg-white/10" : ""}`}
                />
                <RectangleHorizontalIcon
                  onClick={() => setAspectRatio("16:9")}
                  className={`p-2 size-13 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer${aspectRatio === "16:9" ? " ring-violet-500/50 bg-white/10" : ""}`}
                />
              </div>
            </div>
            <div className="mb-4 text-gray-300">
              ...
              <textarea
                ...
                placeholder="Describe how Your Want The Narration To Be."
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:via-violet-500/50 outline-none transition-all"
              />
            </div>
          </div>
